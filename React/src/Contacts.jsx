    ...
    <section className="mb-12">
      ...
      <div className="flex flex-col m-auto max-w-2xl gap-3">
        ...
        >
          ...
          >
            <img
              className="max-w-[50px] rounded-full border-4 border-slate-300 hover:border-blue-700 hover:duration-400 hover:transition shadow-md"
              src={GitHubLogo}
            ></img>
          </a>
          <a
            href="https://www.linkedin.com/in/%D0%BE%D0%BB%D0%B5%D0%B3-%D0%B7%D0%B0%D0%B2%D0%B5%D0%B4%D1%96%D1%8F-90230a30b/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <img
